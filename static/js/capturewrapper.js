...
function Init()
{
    ...
    //设置工具栏的TOOLTIP  
    //captureObj.ToolTipText = "tipRectangle|tipCircle|tipArrow|tipBrush|tipGlitter|tipMosaic|tipText|tipUndo|tipSave|tipCancel|tipFinish|txtFinish";
...
function ShowIntallDownload()
{
    ...
    $('#btnCapture').hide();
	var date = new Date();
    $('#downCapture').attr('src', "http://www.ggniu.cn/download/CaptureInstall.exe?" + date.getMinutes() + date.getSeconds());
    $('#downloadNotice').show();
}
